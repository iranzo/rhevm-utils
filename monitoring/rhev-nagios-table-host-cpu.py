...
description = """
RHEV-nagios-table-host-cpu output  is a script for querying RHEVM via API to get host status
...
# Option parsing
p = optparse.OptionParser("rhev-nagios-table-host-cpu.py [arguments]", description=description)
